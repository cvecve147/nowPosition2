...
final class C5808a {
    ...
    /* renamed from: a */
    public byte[] mo15475a() {
        byte[] bArr = new byte[144];
        int f = this.f16087b.mo15395f();
        int h = this.f16087b.mo15397h();
        for (int i = 0; i < f; i++) {
            int[] iArr = f16086a[i];
            for (int i2 = 0; i2 < h; i2++) {
                int i3 = iArr[i2];
                if (i3 >= 0 && this.f16087b.mo15389b(i2, i)) {
                    int i4 = i3 / 6;
