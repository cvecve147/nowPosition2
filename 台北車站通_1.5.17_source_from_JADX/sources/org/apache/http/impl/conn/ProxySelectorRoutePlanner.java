...
public class ProxySelectorRoutePlanner implements HttpRoutePlanner {
    ...
    static /* synthetic */ class C70111 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.apache.http.impl.conn.ProxySelectorRoutePlanner.C70111.<clinit>():void");
        }
    }
    ...
    public Proxy chooseProxy(List<Proxy> list, HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) {
        ...
        while (proxy == null && i < list.size()) {
            ...
            int i2 = C70111.$SwitchMap$java$net$Proxy$Type[proxy2.type().ordinal()];
            if (i2 == 1 || i2 == 2) {
                proxy = proxy2;
            }
            i++;
