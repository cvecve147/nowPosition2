...
/* renamed from: b.b.h.b.j */
public class C1048j {
    /* renamed from: a */
    public static File m5534a(Context context) {
    ...
    /* renamed from: a */
    public static ByteBuffer m5535a(Context context, Resources resources, int i) {
        File a = m5534a(context);
        if (a == null) {
            return null;
        }
        try {
            if (!m5539a(a, resources, i)) {
                return null;
            }
            ByteBuffer a2 = m5537a(a);
            a.delete();
            return a2;
        } finally {
            a.delete();
    ...
    public static java.nio.ByteBuffer m5536a(android.content.Context r8, android.os.CancellationSignal r9, android.net.Uri r10) {
        /*
        ...
        L_0x0067:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p013b.p018b.p028h.p031b.C1048j.m5536a(android.content.Context, android.os.CancellationSignal, android.net.Uri):java.nio.ByteBuffer");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.nio.ByteBuffer m5537a(java.io.File r9) {
        /*
            r0 = 0
        ...
        L_0x0032:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p013b.p018b.p028h.p031b.C1048j.m5537a(java.io.File):java.nio.ByteBuffer");
    }

    /* renamed from: a */
    public static void m5538a(Closeable closeable) {
        if (closeable != null) {
            try {
                closeable.close();
            } catch (IOException unused) {
    ...
    /* renamed from: a */
    public static boolean m5539a(File file, Resources resources, int i) {
        InputStream inputStream;
        try {
            inputStream = resources.openRawResource(i);
            try {
                boolean a = m5540a(file, inputStream);
                m5538a((Closeable) inputStream);
                return a;
            } catch (Throwable th) {
                th = th;
                m5538a((Closeable) inputStream);
    ...
    /* renamed from: a */
    public static boolean m5540a(File file, InputStream inputStream) {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (read != -1) {
                        ...
                        m5538a((Closeable) fileOutputStream2);
                        return true;
                    }
                }
            } catch (IOException e) {
                ...
                try {
                    ...
                    m5538a((Closeable) fileOutputStream);
                    return false;
                } catch (Throwable th) {
                    th = th;
                    m5538a((Closeable) fileOutputStream);
