...
public class AlertDialogLayout extends C0879qa {
    ...
    /* renamed from: b */
    private void m3536b(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: c */
    private static int m3537c(View view) {
        int j = C0487v.m2294j(view);
        if (j > 0) {
            return j;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m3537c(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: e */
    private void m3538e(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0879qa.C0880a aVar = (C0879qa.C0880a) childAt.getLayoutParams();
                if (aVar.width == -1) {
                    int i4 = aVar.height;
    ...
    /* renamed from: f */
    private boolean m3539f(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C1108f.topPanel) {
                    view = childAt;
                } else if (id == C1108f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C1108f.contentPanel && id != C1108f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            android.support.v7.widget.qa$a r15 = (android.support.p011v7.widget.C0879qa.C0880a) r15
            int r2 = r15.f3625b
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = android.support.p007v4.view.C0487v.m2293i(r17)
            int r2 = android.support.p007v4.view.C0466f.m2170a(r2, r3)
            r2 = r2 & 7
            r3 = 1
        ...
        L_0x00bd:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p011v7.widget.AlertDialogLayout.onLayout(boolean, int, int, int, int):void");
    }
