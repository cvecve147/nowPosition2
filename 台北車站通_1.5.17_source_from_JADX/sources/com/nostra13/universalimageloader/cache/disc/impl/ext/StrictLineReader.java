...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f12536CR = 13;

    /* renamed from: LF */
    private static final byte f12537LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f12538in;
    private int pos;
    ...
    private void fillBuf() {
        InputStream inputStream = this.f12538in;
        byte[] bArr = this.buf;
    ...
    public String readLine() {
        ...
        synchronized (this.f12538in) {
            if (this.buf != null) {
                ...
                C42081 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
