...
public class SystemDefaultRoutePlanner extends DefaultRoutePlanner {
    ...
    static /* synthetic */ class C70131 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.apache.http.impl.conn.SystemDefaultRoutePlanner.C70131.<clinit>():void");
        }
    }
    ...
    private Proxy chooseProxy(List<Proxy> list) {
        ...
        while (proxy == null && i < list.size()) {
            ...
            int i2 = C70131.$SwitchMap$java$net$Proxy$Type[proxy2.type().ordinal()];
            if (i2 == 1 || i2 == 2) {
                proxy = proxy2;
            }
            i++;
