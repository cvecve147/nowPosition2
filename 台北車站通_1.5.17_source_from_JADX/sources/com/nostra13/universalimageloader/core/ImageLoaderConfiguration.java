...
public final class ImageLoaderConfiguration {
    ...
    static /* synthetic */ class C42111 {

        /* renamed from: $SwitchMap$com$nostra13$universalimageloader$core$download$ImageDownloader$Scheme */
        static final /* synthetic */ int[] f12539x4730d1a3 = new int[ImageDownloader.Scheme.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f12539x4730d1a3 = r0
                int[] r0 = f12539x4730d1a3     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f12539x4730d1a3     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.nostra13.universalimageloader.core.ImageLoaderConfiguration.C42111.<clinit>():void");
        }
    }
    ...
    public static class Builder {
        ...
        public ImageLoaderConfiguration build() {
            ...
            return new ImageLoaderConfiguration(this, (C42111) null);
        }
        ...
        public Builder diskCache(DiskCache diskCache2) {
            if (this.diskCacheSize > 0 || this.diskCacheFileCount > 0) {
                C4220L.m16768w(WARNING_OVERLAP_DISK_CACHE_PARAMS, new Object[0]);
            }
            if (this.diskCacheFileNameGenerator != null) {
                C4220L.m16768w(WARNING_OVERLAP_DISK_CACHE_NAME_GENERATOR, new Object[0]);
            }
        ...
        public Builder memoryCache(MemoryCache memoryCache2) {
            if (this.memoryCacheSize != 0) {
                C4220L.m16768w(WARNING_OVERLAP_MEMORY_CACHE, new Object[0]);
            }
        ...
        public Builder taskExecutor(Executor executor) {
            if (!(this.threadPoolSize == 3 && this.threadPriority == 3 && this.tasksProcessingType == DEFAULT_TASK_PROCESSING_TYPE)) {
                C4220L.m16768w(WARNING_OVERLAP_EXECUTOR, new Object[0]);
            }
    ...
    private static class NetworkDeniedImageDownloader implements ImageDownloader {
        ...
        public InputStream getStream(String str, Object obj) {
            int i = C42111.f12539x4730d1a3[ImageDownloader.Scheme.ofUri(str).ordinal()];
            if (i != 1 && i != 2) {
    ...
    private ImageLoaderConfiguration(Builder builder) {
        ...
        C4220L.writeDebugLogs(builder.writeLogs);
    }

    /* synthetic */ ImageLoaderConfiguration(Builder builder, C42111 r2) {
        this(builder);
    }
