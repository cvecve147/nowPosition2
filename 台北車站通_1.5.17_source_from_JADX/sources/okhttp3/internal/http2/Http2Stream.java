...
public final class Http2Stream {
    ...
    final class FramingSink implements Sink {
        ...
        private void emitFrame(boolean z) {
            ...
            Http2Stream.this.writeTimeout.enter();
            try {
                Http2Stream.this.connection.writeData(Http2Stream.this.f18937id, z && min == this.sendBuffer.size(), this.sendBuffer, min);
            } finally {
                Http2Stream.this.writeTimeout.exitAndThrowIfTimedOut();
            }
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x002d, code lost:
            r0 = r8.this$0;
            r0.connection.writeData(r0.f18937id, true, (okio.Buffer) null, 0);
         */
    ...
    private final class FramingSource implements Source {
        ...
        public long read(okio.Buffer r8, long r9) {
            ...
            L_0x001d:
                ...
                int r3 = r3.f18937id     // Catch:{ all -> 0x009b }
    ...
    private boolean closeInternal(ErrorCode errorCode2) {
        synchronized (this) {
            ...
            notifyAll();
            this.connection.removeStream(this.f18937id);
            return true;
        }
    }
    ...
    public void close(ErrorCode errorCode2) {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynReset(this.f18937id, errorCode2);
        }
    }

    public void closeLater(ErrorCode errorCode2) {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynResetLater(this.f18937id, errorCode2);
        }
    }
    ...
    public boolean isLocallyInitiated() {
        return this.connection.client == ((this.f18937id & 1) == 1);
    }
    ...
    public void sendResponseHeaders(List<Header> list, boolean z) {
        if (list != null) {
            ...
            this.connection.writeSynReply(this.f18937id, z2, list);
            if (z2) {
