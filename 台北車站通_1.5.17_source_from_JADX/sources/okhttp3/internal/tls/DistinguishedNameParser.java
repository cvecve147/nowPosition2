...
final class DistinguishedNameParser {
    ...
    /* renamed from: dn */
    private final String f18938dn;
    private int end;
    private final int length = this.f18938dn.length();
    private int pos;

    DistinguishedNameParser(X500Principal x500Principal) {
        this.f18938dn = x500Principal.getName("RFC2253");
    }
    ...
    private int getByte(int i) {
        ...
        if (i4 < this.length) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                throw new IllegalStateException("Malformed DN: " + this.f18938dn);
            } else {
                i2 = c - '7';
            }
    ...
    private char getEscaped() {
        ...
        throw new IllegalStateException("Unexpected end of DN: " + this.f18938dn);
    }
            ...
            while (true) {
                ...
                if (cArr[i2] == '+' || cArr[i2] == ',' || cArr[i2] == ';') {
                    ...
                    if (cArr[i2] >= 'A' && cArr[i2] <= 'F') {
                        cArr[i2] = (char) (cArr[i2] + TokenParser.f19315SP);
                    }
                    i = this.pos;
                }
            }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f18938dn.toCharArray();
