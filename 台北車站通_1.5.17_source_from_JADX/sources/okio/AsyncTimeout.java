...
public class AsyncTimeout extends Timeout {
    ...
    private static synchronized void scheduleTimeout(okio.AsyncTimeout r5, long r6, boolean r8) {
        ...
        L_0x0016:
            ...
            long r3 = r5.deadlineNanoTime()     // Catch:{ all -> 0x0069 }
            long r3 = r3 - r1
            long r6 = java.lang.Math.min(r6, r3)     // Catch:{ all -> 0x0069 }
        L_0x002b:
            long r6 = r6 + r1
            r5.timeoutAt = r6     // Catch:{ all -> 0x0069 }
            goto L_0x003a
        L_0x002f:
        ...
        L_0x0032:
            ...
            long r6 = r5.deadlineNanoTime()     // Catch:{ all -> 0x0069 }
            r5.timeoutAt = r6     // Catch:{ all -> 0x0069 }
        L_0x003a:
            long r6 = r5.remainingNanos(r1)     // Catch:{ all -> 0x0069 }
            okio.AsyncTimeout r8 = head     // Catch:{ all -> 0x0069 }
        L_0x0040:
            okio.AsyncTimeout r3 = r8.next     // Catch:{ all -> 0x0069 }
            ...
            goto L_0x0052
        L_0x004f:
            okio.AsyncTimeout r8 = r8.next     // Catch:{ all -> 0x0069 }
            goto L_0x0040
        L_0x0052:
            okio.AsyncTimeout r6 = r8.next     // Catch:{ all -> 0x0069 }
            r5.next = r6     // Catch:{ all -> 0x0069 }
            r8.next = r5     // Catch:{ all -> 0x0069 }
            okio.AsyncTimeout r5 = head     // Catch:{ all -> 0x0069 }
