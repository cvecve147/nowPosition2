...
public final class C3439rl {
    /* renamed from: a */
    public static int m13663a(EllipticCurve ellipticCurve) {
        return (m13670b(ellipticCurve).subtract(BigInteger.ONE).bitLength() + 7) / 8;
    }

    /* renamed from: a */
    public static KeyPair m13664a(ECParameterSpec eCParameterSpec) {
        KeyPairGenerator a = C3582wl.f10448h.mo10164a("EC");
        a.initialize(eCParameterSpec);
        return a.generateKeyPair();
    }

    /* renamed from: a */
    public static ECPublicKey m13665a(C3496tl tlVar, byte[] bArr, byte[] bArr2) {
        ECParameterSpec a = m13666a(tlVar);
        ECPoint eCPoint = new ECPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
        m13668a(eCPoint, a.getCurve());
        return (ECPublicKey) C3582wl.f10449i.mo10164a("EC").generatePublic(new ECPublicKeySpec(eCPoint, a));
    }

    /* renamed from: a */
    public static ECParameterSpec m13666a(C3496tl tlVar) {
        String str;
        String str2;
        String str3;
        String str4;
        String str5;
        int i = C3467sl.f10209b[tlVar.ordinal()];
        if (i == 1) {
        ...
        return m13667a(str, str2, str3, str4, str5);
    }

    /* renamed from: a */
    private static ECParameterSpec m13667a(String str, String str2, String str3, String str4, String str5) {
        BigInteger bigInteger = new BigInteger(str);
        return new ECParameterSpec(new EllipticCurve(new ECFieldFp(bigInteger), bigInteger.subtract(new BigInteger("3")), new BigInteger(str3, 16)), new ECPoint(new BigInteger(str4, 16), new BigInteger(str5, 16)), new BigInteger(str2), 1);
    }

    /* renamed from: a */
    static void m13668a(ECPoint eCPoint, EllipticCurve ellipticCurve) {
        BigInteger b = m13670b(ellipticCurve);
    ...
    /* renamed from: a */
    public static byte[] m13669a(ECPrivateKey eCPrivateKey, ECPoint eCPoint) {
        BigInteger bigInteger;
        m13668a(eCPoint, eCPrivateKey.getParams().getCurve());
        ECParameterSpec params = eCPrivateKey.getParams();
        params.getCurve();
        PublicKey generatePublic = KeyFactory.getInstance("EC").generatePublic(new ECPublicKeySpec(eCPoint, params));
        KeyAgreement a = C3582wl.f10447g.mo10164a("ECDH");
        a.init(eCPrivateKey);
        a.doPhase(generatePublic, true);
        byte[] generateSecret = a.generateSecret();
        EllipticCurve curve = eCPrivateKey.getParams().getCurve();
        BigInteger bigInteger2 = new BigInteger(1, generateSecret);
        if (bigInteger2.signum() == -1 || bigInteger2.compareTo(m13670b(curve)) != -1) {
            throw new GeneralSecurityException("shared secret is out of range");
        }
        BigInteger b = m13670b(curve);
        ...
        if (b.signum() == 1) {
            ...
            if (mod2.equals(BigInteger.ZERO)) {
                ...
                if (b.testBit(0) && b.testBit(1)) {
                    ...
                    BigInteger shiftRight = b.subtract(bigInteger).shiftRight(1);
                    int i = 0;
                    while (true) {
    ...
    /* renamed from: b */
    private static BigInteger m13670b(EllipticCurve ellipticCurve) {
