...
public interface C0385a extends IInterface {

    /* renamed from: android.support.v4.media.session.a$a */
    public static abstract class C0386a extends Binder implements C0385a {
        public C0386a() {
        ...
        public boolean onTransact(int r5, android.os.Parcel r6, android.os.Parcel r7, int r8) {
            ...
            L_0x005d:
                r4.mo1654a((android.support.p007v4.media.session.ParcelableVolumeInfo) r3)
                return r2
            L_0x0061:
                r6.enforceInterface(r1)
                int r5 = r6.readInt()
            ...
            L_0x0089:
                r4.mo1655a((java.lang.CharSequence) r3)
                return r2
            L_0x008d:
                r6.enforceInterface(r1)
                ...
                r4.mo1656a((java.util.List<android.support.p007v4.media.session.MediaSessionCompat$QueueItem>) r5)
                return r2
            L_0x009a:
                r6.enforceInterface(r1)
                int r5 = r6.readInt()
            ...
            L_0x00ac:
                r4.mo1653a((android.support.p007v4.media.MediaMetadataCompat) r3)
                return r2
            L_0x00b0:
                r6.enforceInterface(r1)
                int r5 = r6.readInt()
            ...
            L_0x00c2:
                r4.mo1677a((android.support.p007v4.media.session.PlaybackStateCompat) r3)
                return r2
            L_0x00c6:
                r6.enforceInterface(r1)
                r4.mo1658w()
            ...
            L_0x00e7:
                ...
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p007v4.media.session.C0385a.C0386a.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }
    }
    ...
    /* renamed from: a */
    void mo1653a(MediaMetadataCompat mediaMetadataCompat);

    /* renamed from: a */
    void mo1654a(ParcelableVolumeInfo parcelableVolumeInfo);

    /* renamed from: a */
    void mo1677a(PlaybackStateCompat playbackStateCompat);

    /* renamed from: a */
    void mo1655a(CharSequence charSequence);

    /* renamed from: a */
    void mo1656a(List<MediaSessionCompat$QueueItem> list);

    /* renamed from: b */
    void mo1678b(int i);

    /* renamed from: b */
    void mo1679b(boolean z);

    /* renamed from: c */
    void mo1680c(String str, Bundle bundle);

    /* renamed from: c */
    void mo1681c(boolean z);

    /* renamed from: d */
    void mo1682d(int i);

    /* renamed from: f */
    void mo1657f(Bundle bundle);
