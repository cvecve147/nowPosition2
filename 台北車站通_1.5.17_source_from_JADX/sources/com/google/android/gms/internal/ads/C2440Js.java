...
public final class C2440Js extends C2237Co<C2440Js> {

    /* renamed from: c */
    private Integer f7384c = null;

    /* renamed from: d */
    private Integer f7385d = null;
    ...
    public final /* synthetic */ C2408Io mo7847a(C3641yo yoVar) {
        while (true) {
            ...
            if (d == 8) {
                this.f7384c = Integer.valueOf(yoVar.mo10249h());
            } else if (d == 16) {
                this.f7385d = Integer.valueOf(yoVar.mo10249h());
