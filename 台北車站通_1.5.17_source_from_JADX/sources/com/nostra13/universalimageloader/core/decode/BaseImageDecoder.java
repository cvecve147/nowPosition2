...
public class BaseImageDecoder implements ImageDecoder {
        ...
        if (imageScaleType == ImageScaleType.EXACTLY || imageScaleType == ImageScaleType.EXACTLY_STRETCHED) {
            ...
            if (Float.compare(computeImageScale, 1.0f) != 0) {
                ...
                if (this.loggingEnabled) {
                    C4220L.m16763d(LOG_SCALE_IMAGE, imageSize, imageSize.scale(computeImageScale), Float.valueOf(computeImageScale), imageDecodingInfo.getImageKey());
                }
            }
        }
        if (z) {
            ...
            if (this.loggingEnabled) {
                C4220L.m16763d(LOG_FLIP_IMAGE, imageDecodingInfo.getImageKey());
            }
        }
        if (i != 0) {
            matrix.postRotate((float) i);
            if (this.loggingEnabled) {
                C4220L.m16763d(LOG_ROTATE_IMAGE, Integer.valueOf(i), imageDecodingInfo.getImageKey());
            }
        }
    ...
    public Bitmap decode(ImageDecodingInfo imageDecodingInfo) {
        ...
        if (imageStream == null) {
            C4220L.m16764e(ERROR_NO_IMAGE_STREAM, imageDecodingInfo.getImageKey());
            return null;
        }
        try {
            ...
            if (decodeStream == null) {
                C4220L.m16764e(ERROR_CANT_DECODE_IMAGE, imageDecodingInfo.getImageKey());
                return decodeStream;
            }
    ...
    public com.nostra13.universalimageloader.core.decode.BaseImageDecoder.ExifInfo defineExifOrientation(java.lang.String r5) {
        ...
        L_0x0025:
            ...
            com.nostra13.universalimageloader.utils.C4220L.m16768w(r5, r1)
        L_0x002e:
            r1 = r0
        L_0x002f:
    ...
    public BitmapFactory.Options prepareDecodingOptions(ImageSize imageSize, ImageDecodingInfo imageDecodingInfo) {
        ...
        if (i > 1 && this.loggingEnabled) {
            C4220L.m16763d(LOG_SUBSAMPLE_IMAGE, imageSize, imageSize.scaleDown(i), Integer.valueOf(i), imageDecodingInfo.getImageKey());
        }
