...
import com.google.android.gms.common.util.C2088j;
...
public class C2064k {
    ...
    public static void ensurePlayServicesAvailable(Context context, int i) {
        int a = C1993f.m8774a().mo7526a(context, i);
        if (a != 0) {
            Intent a2 = C1993f.m8774a().mo7532a(context, a, "e");
            ...
            throw new C2063j(a, "Google Play Services not available", a2);
        }
    }
    ...
    public static int getClientVersion(Context context) {
        C2061y.m9077b(true);
        return C2082d.m9109a(context, context.getPackageName());
    }

    @Deprecated
    public static PendingIntent getErrorPendingIntent(int i, Context context, int i2) {
        return C1993f.m8774a().mo7528a(context, i, i2);
    }

    @Deprecated
    public static String getErrorString(int i) {
        return ConnectionResult.m8236c(i);
    }

    @Deprecated
    public static Intent getGooglePlayServicesAvailabilityRecoveryIntent(int i) {
        return C1993f.m8774a().mo7532a((Context) null, i, (String) null);
    }
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        try {
            context.getResources().getString(C2066m.common_google_play_services_unknown_issue);
        } catch (Throwable unused) {
            Log.e("GooglePlayServicesUtil", "The Google Play services resources were not found. Check your project configuration to ensure that the resources are included.");
        }
        if (!"com.google.android.gms".equals(context.getPackageName()) && !zzbu.get()) {
            int b = C2058w.m9060b(context);
            if (b != 0) {
        ...
        return zza(context, !C2087i.m9152d(context) && !C2087i.m9149a(context), i);
    }

    @Deprecated
    public static boolean isGooglePlayServicesUid(Context context, int i) {
        return C2098t.m9180a(context, i);
    }
    ...
    public static boolean isRestrictedUserProfile(android.content.Context r1) {
        /*
            boolean r0 = com.google.android.gms.common.util.C2092n.m9165f()
        ...
        L_0x0028:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.C2064k.isRestrictedUserProfile(android.content.Context):boolean");
    }

    @Deprecated
    public static boolean isSidewinderDevice(Context context) {
        return C2087i.m9150b(context);
    }

    public static boolean isTestKeysBuild(Context context) {
        if (!zzbs) {
            try {
                PackageInfo b = C1989c.m8748b(context).mo7521b("com.google.android.gms", 64);
                C2065l a = C2065l.m9082a(context);
                if (b == null || a.mo7717a(b, false) || !a.mo7717a(b, true)) {
                    zzbr = false;
                } else {
                    zzbr = true;
                }
    ...
    public static boolean uidHasPackageName(Context context, int i, String str) {
        return C2098t.m9181a(context, i, str);
    }
    ...
    private static int zza(Context context, boolean z, int i) {
        ...
        try {
            ...
            C2065l a = C2065l.m9082a(context);
            if (!a.mo7717a(packageInfo2, true)) {
                str = "Google Play services signature invalid.";
            } else if (z && (!a.mo7717a(packageInfo, true) || !packageInfo.signatures[0].equals(packageInfo2.signatures[0]))) {
                str = "Google Play Store signature invalid.";
            } else if (C2088j.m9153a(packageInfo2.versionCode) < C2088j.m9153a(i)) {
