...
/* renamed from: b.b.h.b.b */
public class C1036b {

    /* renamed from: b.b.h.b.b$a */
    ...
    public static class C1038b {
        ...
        C1038b(char c, float[] fArr) {
            this.f3949a = c;
            this.f3950b = fArr;
        }

        C1038b(C1038b bVar) {
            this.f3949a = bVar.f3949a;
            float[] fArr = bVar.f3950b;
            this.f3950b = C1036b.m5480a(fArr, 0, fArr.length);
        }

        /* renamed from: a */
        private static void m5486a(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            double d10 = d3;
        ...
        /* renamed from: a */
        private static void m5487a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            double d;
            double d2;
            float f8 = f;
            float f9 = f3;
            ...
            if (d23 < 0.0d) {
                ...
                m5487a(path, f, f2, f3, f4, f10 * sqrt, f6 * sqrt, f7, z, z2);
                return;
            }
            ...
            double d26 = d2 * d15;
            double d27 = d * d11;
            m5486a(path, (d26 * cos) - (d27 * d21), (d26 * d21) + (d27 * cos), d15, d11, d5, d10, radians, atan2, atan22);
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:105:0x0240, code lost:
            ...
            r8 = r22;
            r22 = r9;
            m5487a(r24, r1, r2, r3, r4, r5, r6, r7, r8, r23);
            r8 = r15 + r12[r13];
            r7 = r11 + r12[r14];
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:118:0x02f1, code lost:
            m5487a(r24, r15, r11, r3, r4, r5, r6, r7, r8, r9);
            r8 = r12[r13];
            r7 = r12[r14];
         */
        ...
        private static void m5488a(android.graphics.Path r24, float[] r25, char r26, char r27, float[] r28) {
            /*
                r10 = r24
                r11 = r27
                r12 = r28
            ...
            L_0x0240:
                ...
                r22 = r9
                r9 = r23
                m5487a((android.graphics.Path) r0, (float) r1, (float) r2, (float) r3, (float) r4, (float) r5, (float) r6, (float) r7, (boolean) r8, (boolean) r9)
                r0 = r12[r13]
                float r8 = r15 + r0
                r0 = r12[r14]
                float r7 = r11 + r0
            ...
            L_0x0308:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p013b.p018b.p028h.p031b.C1036b.C1038b.m5488a(android.graphics.Path, float[], char, char, float[]):void");
        }

        /* renamed from: a */
        public static void m5489a(C1038b[] bVarArr, Path path) {
            float[] fArr = new float[6];
            char c = 'm';
            for (int i = 0; i < bVarArr.length; i++) {
                m5488a(path, fArr, c, bVarArr[i].f3949a, bVarArr[i].f3950b);
                c = bVarArr[i].f3949a;
            }
        }

        /* renamed from: a */
        public void mo5063a(C1038b bVar, C1038b bVar2, float f) {
            int i = 0;
            while (true) {
                float[] fArr = bVar.f3950b;
                if (i < fArr.length) {
                    this.f3950b[i] = (fArr[i] * (1.0f - f)) + (bVar2.f3950b[i] * f);
                    i++;
                } else {
                    return;
                }
    ...
    /* renamed from: a */
    private static int m5476a(String str, int i) {
        while (i < str.length()) {
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static void m5477a(java.lang.String r8, int r9, p013b.p018b.p028h.p031b.C1036b.C1037a r10) {
        /*
            r0 = 0
            r10.f3948b = r0
            r1 = r9
        ...
        L_0x003b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p013b.p018b.p028h.p031b.C1036b.m5477a(java.lang.String, int, b.b.h.b.b$a):void");
    }

    /* renamed from: a */
    private static void m5478a(ArrayList<C1038b> arrayList, char c, float[] fArr) {
        arrayList.add(new C1038b(c, fArr));
    }

    /* renamed from: a */
    public static boolean m5479a(C1038b[] bVarArr, C1038b[] bVarArr2) {
        if (bVarArr == null || bVarArr2 == null || bVarArr.length != bVarArr2.length) {
            return false;
        }
        for (int i = 0; i < bVarArr.length; i++) {
            if (bVarArr[i].f3949a != bVarArr2[i].f3949a || bVarArr[i].f3950b.length != bVarArr2[i].f3950b.length) {
                return false;
            }
        }
        return true;
    ...
    /* renamed from: a */
    static float[] m5480a(float[] fArr, int i, int i2) {
        if (i <= i2) {
    ...
    /* renamed from: a */
    public static C1038b[] m5481a(String str) {
        if (str == null) {
            return null;
        }
        ...
        while (i < str.length()) {
            ...
            if (trim.length() > 0) {
                m5478a((ArrayList<C1038b>) arrayList, trim.charAt(0), m5485c(trim));
            }
            i2 = a;
            i = a + 1;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            m5478a((ArrayList<C1038b>) arrayList, str.charAt(i2), new float[0]);
        }
        return (C1038b[]) arrayList.toArray(new C1038b[arrayList.size()]);
    }

    /* renamed from: a */
    public static C1038b[] m5482a(C1038b[] bVarArr) {
        if (bVarArr == null) {
            return null;
        }
        C1038b[] bVarArr2 = new C1038b[bVarArr.length];
        for (int i = 0; i < bVarArr.length; i++) {
            bVarArr2[i] = new C1038b(bVarArr[i]);
        }
        return bVarArr2;
    }

    /* renamed from: b */
    public static Path m5483b(String str) {
        Path path = new Path();
        C1038b[] a = m5481a(str);
        if (a == null) {
            return null;
    ...
    /* renamed from: b */
    public static void m5484b(C1038b[] bVarArr, C1038b[] bVarArr2) {
        for (int i = 0; i < bVarArr2.length; i++) {
            bVarArr[i].f3949a = bVarArr2[i].f3949a;
            for (int i2 = 0; i2 < bVarArr2[i].f3950b.length; i2++) {
                bVarArr[i].f3950b[i2] = bVarArr2[i].f3950b[i2];
            }
        }
    }

    /* renamed from: c */
    private static float[] m5485c(String str) {
        if (str.charAt(0) == 'z' || str.charAt(0) == 'Z') {
            return new float[0];
        }
        try {
            float[] fArr = new float[str.length()];
            C1037a aVar = new C1037a();
            ...
            while (i < length) {
                ...
                i = aVar.f3948b ? i3 : i3 + 1;
            }
            return m5480a(fArr, 0, i2);
