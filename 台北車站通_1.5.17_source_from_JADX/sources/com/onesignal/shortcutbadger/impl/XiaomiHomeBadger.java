...
@Deprecated
public class XiaomiHomeBadger implements C4333a {

    /* renamed from: a */
    private ResolveInfo f13041a;

    @TargetApi(16)
    /* renamed from: a */
    private void m17570a(Context context, int i) {
        if (this.f13041a == null) {
            Intent intent = new Intent("android.intent.action.MAIN");
            intent.addCategory("android.intent.category.HOME");
            this.f13041a = context.getPackageManager().resolveActivity(intent, 65536);
        }
        if (this.f13041a != null) {
            NotificationManager notificationManager = (NotificationManager) context.getSystemService("notification");
            Notification build = new Notification.Builder(context).setContentTitle("").setContentText("").setSmallIcon(this.f13041a.getIconResource()).build();
            try {
                ...
                throw new C4336b("not able to set badge", e);
            }
        }
    }
    ...
    public void mo12459a(android.content.Context r5, android.content.ComponentName r6, int r7) {
        /*
            r4 = this;
            java.lang.String r0 = ""
        ...
        L_0x0061:
            ...
            r1.putExtra(r0, r6)
            boolean r6 = com.onesignal.p085a.p086a.C4334a.m17281a(r5, r1)
        ...
        L_0x0080:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.onesignal.shortcutbadger.impl.XiaomiHomeBadger.mo12459a(android.content.Context, android.content.ComponentName, int):void");
    }
}
